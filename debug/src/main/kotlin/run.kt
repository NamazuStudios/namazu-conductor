        ...
        .withDeployment { builder ->
            ...
            loadProperties("ecs.properties")?.let { props ->
                builder
                    ...
                    .elmArtifact("dev.getelements.conductor:ecs:elm:1.2.10-SNAPSHOT")
                    .endElementPackage()
            }
            ...
            loadProperties("edgegap.properties")?.let { props ->
                builder
                    ...
                    .elmArtifact("dev.getelements.conductor:edgegap:elm:1.2.10-SNAPSHOT")
                    .endElementPackage()
            }
            ...
            loadProperties("kubernetes.properties")?.let { props ->
                builder
                    ...
                    .elmArtifact("dev.getelements.conductor:kubernetes:elm:1.2.10-SNAPSHOT")
                    .endElementPackage()
            }

            builder
                .elementPackage()
                .elmArtifact("dev.getelements.conductor:admin:elm:1.2.10-SNAPSHOT")
                .endElementPackage()
